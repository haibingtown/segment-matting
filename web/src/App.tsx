  ...
  const runModel = async () => {
    ...
    try {
      ...
      if (hasClicked) {
        ...
        const pred_mask = results[model.outputNames[2]];
        // const low_res_mask = results[model.outputNames[2]];
        // var data = getAllMasks(low_res_mask.data, low_res_mask.dims[2],low_res_mask.dims[3])[0]
        // const pred_mask = new Tensor("float32", data, [1, 1, low_res_mask.dims[2], low_res_mask.dims[3]])
